...
export default function Template1() {
  ...
  return (
    <div className="flex flex-col space-y-4 w-xs overflow-hidden h-[600px] rounded-3xl drop-shadow-xl text-xs px-4 bg-background-mockup mx-auto text-text-mockup">
      <Nav />
