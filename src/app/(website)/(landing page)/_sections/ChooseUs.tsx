...
export default function ChooseUs() {
  return (
    <section className="grid grid-cols-1  lg:grid-cols-[auto_auto] 2xl:grid-cols-2 gap-y-10 sm:pr-20 lg:pr-0">
      <div className=" space-y-3 lg:max-w-sm xl:max-w-xl">
        <h2 className="font-semibold text-primary md:text-lg 2xl:text-xl">Why Qrderly?</h2>
        <p className="text-lg md:text-xl lg:text-2xl text-balance 2xl:text-3xl">
          We let you create, launch, and manage everything on your own—no business or third-party intervention needed.
        </p>
      </div>
