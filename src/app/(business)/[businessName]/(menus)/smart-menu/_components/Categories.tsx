...
export default function Categories({ categories }: { categories: Category[] }) {
  ...
  return (
    <div className="sticky top-0 z-10  bg-myWhite/70 font-medium text-black backdrop-blur-2xl lg:pt-[100px]">
      <div className="scrollbar-hidden my-container flex items-center gap-4 overflow-auto py-4 text-lg capitalize lg:gap-7 border-y-2 border-y-muted-foreground">
        ...
        {categories.map((category) => (
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-medium transition-colors lg:text-base xl:hover:bg-primary ${
