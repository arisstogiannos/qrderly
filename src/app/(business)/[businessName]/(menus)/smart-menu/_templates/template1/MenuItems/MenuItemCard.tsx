        ...
        >
          ...
          >
            <div className="space-y-1 lg:space-y-1">
              <h3 className={"text-base lg:text-lg capitalize"}>{existingTranslation && translationsAsJson[lang].name?translationsAsJson[lang].name:name}</h3>
              <p
                className={
                  "line-clamp-2 text-sm text-muted-foreground lg:text-sm max-w-[140px]"
                }
              >
                {existingTranslation && translationsAsJson[lang].name?translationsAsJson[lang].description:description}
              </p>
            </div>
