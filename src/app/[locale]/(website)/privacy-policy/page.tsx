...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
      ...
      <p className="mb-4">
        This Privacy Notice for scanby ("we," "us," or "our"), describes how and
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          Visit our website at https://www.scanby.cloud, or any website of ours
      ...
      <p className="mb-4">
        ...
        handled and stored by Stripe. You may find their privacy notice here:
        <a
      ...
      <p className="mb-4">
        <strong>In Short:</strong> Some information — such as your IP address
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Consent:</strong> You have given us permission to use your
          personal information for a specific purpose.
        </li>
        <li>
          <strong>Performance of a Contract:</strong> We process your data to
          fulfill our contractual obligations to you.
        </li>
        <li>
          <strong>Legitimate Interests:</strong> For business interests that do
      ...
      <p className="mb-4">
        In some exceptional cases, we may process your information without your
        consent if permitted by law, such as:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          In emergencies where consent cannot be obtained in a timely way.
        </li>
      ...
      <p className="mb-4 font-medium">In Short:</p>
      <p className="mb-4">
        We may share information in specific situations described below and/or
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          ...
          information with Google Maps Platform APIs to provide location-based
          services. Google uses GPS, Wi-Fi, and cell towers to estimate
          location, which may be cached on your device. You can revoke your
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          ...
          previous section titled "HOW DO WE PROCESS YOUR INFORMATION?" Google
          Maps uses GPS, Wi-Fi, and cell towers to estimate your location. GPS
          is accurate to about 20 meters, while Wi-Fi and cell towers help
          improve accuracy when GPS signals are weak, like indoors. This data
          helps Google Maps provide directions, but it is not always perfectly
          precise. We obtain and store on your device ("cache") your location.
          You may revoke your consent anytime by contacting us at the contact
          details provided at the end of this document. The Google Maps Platform
          ...
          Area (EU countries, Iceland, Liechtenstein, and Norway) or the United
      ...
      <p className="mb-4">
        ...
        use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE
        RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI
      ...
      <section>
        ...
        <p>
          ...
          please contact us at info@scanby.cloud.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4">
          Sources of Personal Information: Learn more about the sources of
          personal information we collect in "WHAT INFORMATION DO WE COLLECT?"
        </p>
        <p>
          How We Use and Share Personal Information: Learn more in the section,
        ...
        <p className="mt-2">
          ...
          rights including access to categories of processed data, lists of
          third parties we disclosed data to, and options to limit or opt out of
          sensitive data processing, especially related to facial or voice
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <a
              href="https://www.scanby.cloud/en/FAQ-contact"
              className="text-blue-600 underline"
            >
        ...
        <p>
          You may also use the contact details at the bottom of this document.
        </p>

        <p className="mt-4">
          If you submit the request through an authorized agent, they must
          provide proof of authorization. We may still need to verify your
          identity before processing any request. We may deny requests from
          agents without sufficient documentation.
        </p>
        ...
        <p>
          ...
          . We will provide a written explanation for our decision. If your
          appeal is denied, you may contact your state attorney general to
          submit a complaint.
        </p>
        ...
        <p>
          ...
          request, once a year and free of charge, information about categories
          ...
          parties with which we shared personal information in the preceding
          calendar year. To request this information, please contact us using
          the information in the section "HOW CAN YOU CONTACT US ABOUT THIS
          NOTICE?"
        </p>
      </section>
      <section>
