const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
      ...
      <p className="text-sm text-gray-600 mb-6">Last updated May 05, 2025</p>

      <p className="mb-4">
        This Privacy Notice for scanby ("we," "us," or "our"), describes how and why we might
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          Visit our website at https://www.scanby.cloud, or any website of ours that links to this
          Privacy Notice
        </li>
      ...
      <p className="mb-4">
        ...
        <a href="mailto:info@scanby.cloud" className="text-blue-600 underline">
          info@scanby.cloud
        </a>
        .
      </p>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          ...
          is by visiting{' '}
          <a
            href="https://www.scanby.cloud/FAQ-contact#contact-form"
            className="text-blue-600 underline"
          >
            www.scanby.cloud/FAQ-contact#contact-form
          </a>
      ...
      <h2 className="text-xl font-bold mt-8 mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>
      ...
      <p className="mb-4 font-medium">Sensitive Information:</p>
      <p className="mb-4">We do not process sensitive information.</p>

      <p className="mb-4 font-medium">Payment Data:</p>
      <p className="mb-4">
        We may collect data necessary to process your payment if you choose to make purchases, such
        as your payment instrument number, and the security code associated with your payment
        instrument. All payment data is handled and stored by Stripe. You may find their privacy
        notice here:
        <a href="https://stripe.com/en-gr/privacy" className="text-blue-600 underline ml-1">
          https://stripe.com/en-gr/privacy
        </a>
        .
      </p>

      <p className="mb-4 font-medium">Social Media Login Data:</p>
      <p className="mb-4">
        We may provide you with the option to register with us using your existing social media
        account details, like your Facebook, X, or other social media account. If you choose to
        register in this way, we will collect certain profile information about you from the social
        media provider, as described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS?"
      </p>
      ...
      <p className="mb-4">
        <strong>In Short:</strong> Some information — such as your IP address and/or browser and
      ...
      <p className="mb-2 font-medium">The information we collect includes:</p>
      <ul className="list-disc pl-6 mb-4">
        <li>
      ...
      <h2 className="text-xl font-bold mt-8 mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
      <p className="mb-4 font-medium">In Short:</p>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold mb-2">If you are located in the EU or UK</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <strong>Performance of a Contract:</strong> We process your data to fulfill our
          contractual obligations to you.
        </li>
        <li>
          <strong>Legitimate Interests:</strong> For business interests that do not override your
          fundamental rights.
        </li>
        <li>
          <strong>Legal Obligations:</strong> To comply with legal obligations.
        </li>
        <li>
          <strong>Vital Interests:</strong> To protect someone’s life or safety.
        </li>
      </ul>

      <h3 className="text-lg font-semibold mb-2">If you are located in Canada</h3>
      <p className="mb-4">
        We may process your information with your express or implied consent. You can withdraw your
        consent at any time.
      </p>
      <p className="mb-4">
        In some exceptional cases, we may process your information without your consent if permitted
        by law, such as:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>In emergencies where consent cannot be obtained in a timely way.</li>
        <li>For investigations, fraud detection, and prevention.</li>
        <li>For certain business transactions.</li>
        <li>For legal claims or law enforcement requirements.</li>
        <li>To identify individuals or communicate with next of kin.</li>
        <li>Where public interest or legal disclosure is justified.</li>
      </ul>
      ...
      <p className="mb-4 font-medium">In Short:</p>
      <p className="mb-4">
        We may share information in specific situations described below and/or with the following
        third parties.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <strong>Google Maps Platform APIs:</strong> We may share your information with Google Maps
          Platform APIs to provide location-based services. Google uses GPS, Wi-Fi, and cell towers
          to estimate location, which may be cached on your device. You can revoke your consent at
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          ...
          do not outweigh your interests and fundamental rights and freedoms. For example, we may
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          ...
          certain Google Maps Platform APIs (e.g., Google Maps API, Places API). We use certain
          Google Maps Platform APIs to retrieve certain information when you make location-specific
          requests. This includes: location; and other similar information. A full list of what we
          use information for can be found in this section and in the previous section titled "HOW
          DO WE PROCESS YOUR INFORMATION?" Google Maps uses GPS, Wi-Fi, and cell towers to estimate
          your location. GPS is accurate to about 20 meters, while Wi-Fi and cell towers help
          improve accuracy when GPS signals are weak, like indoors. This data helps Google Maps
          provide directions, but it is not always perfectly precise. We obtain and store on your
          device ("cache") your location. You may revoke your consent anytime by contacting us at
          the contact details provided at the end of this document. The Google Maps Platform APIs
          that we use store and access cookies and other information on your devices. If you are a
          user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and
          Norway) or the United Kingdom, please take a look at our Cookie Notice.
        </li>
      </ul>
      <h2 className="text-xl font-bold mt-8 mb-4">
      ...
      <p className="mb-4">
        ...
        Analytics across the Services, visit https://tools.google.com/dlpage/gaoptout. You can opt
        out of Google Analytics Advertising Features through Ads Settings and Ad Settings for mobile
      ...
      <p className="mb-4">
        ...
        enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON
        TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that
      ...
      <h2 className="text-xl font-bold mt-8 mb-4">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
      <p className="mb-4 font-medium">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">10. DO WE COLLECT INFORMATION FROM MINORS?</h2>
        <p>
        ...
        <p>
          ...
          contact us at info@scanby.cloud.
        </p>
      </section>

      <section>
        <h2 className="text-xl font-semibold mb-2">11. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <p>
        ...
        <p>
          ...
          provided in the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below. You will then
        ...
        <h3 className="text-lg font-medium mt-4">Cookies and similar technologies</h3>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">12. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        <p>
      ...
      <section>
        ...
        <h3 className="text-lg font-medium mt-4">Categories of Personal Information We Collect</h3>
        <p>
        ...
        <p className="mt-4">
          Sources of Personal Information: Learn more about the sources of personal information we
          collect in "WHAT INFORMATION DO WE COLLECT?"
        </p>
        <p>
          How We Use and Share Personal Information: Learn more in the section, "HOW DO WE PROCESS
          YOUR INFORMATION?"
        </p>

        <p className="mt-4 font-medium">Will your information be shared with anyone else?</p>
        <p>
          ...
          information in the section, "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"
        </p>
        <p>
        ...
        <p className="mt-2">
          ...
          access to categories of processed data, lists of third parties we disclosed data to, and
          options to limit or opt out of sensitive data processing, especially related to facial or
          voice recognition technologies.
        </p>

        <h3 className="text-lg font-medium mt-6">How to Exercise Your Rights</h3>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <a href="https://www.scanby.cloud/en/FAQ-contact" className="text-blue-600 underline">
              www.scanby.cloud/en/FAQ-contact
            </a>
          </li>
        </ul>
        <p>You may also use the contact details at the bottom of this document.</p>

        <p className="mt-4">
          If you submit the request through an authorized agent, they must provide proof of
          authorization. We may still need to verify your identity before processing any request. We
          may deny requests from agents without sufficient documentation.
        </p>

        <h3 className="text-lg font-medium mt-6">Appeals</h3>
        <p>
          If we decline to act on your request, you may appeal by emailing us at{' '}
          <a href="mailto:info@scanby.cloud" className="text-blue-600 underline">
            info@scanby.cloud
          </a>
          . We will provide a written explanation for our decision. If your appeal is denied, you
          may contact your state attorney general to submit a complaint.
        </p>

        <h3 className="text-lg font-medium mt-6">California "Shine The Light" Law</h3>
        <p>
          ...
          all third parties with which we shared personal information in the preceding calendar
          year. To request this information, please contact us using the information in the section
      ...
      <section>
        ...
        <p>
          <strong>In Short:</strong> You may have additional rights based on the country you reside
          in.
        </p>

        <h3 className="text-lg font-medium mt-4">Australia and New Zealand</h3>
        <p>
        ...
        <h3 className="text-lg font-medium mt-4">Republic of South Africa</h3>
        <p>
          At any time, you have the right to request access to or correction of your personal
          information. You can make such a request by contacting us by using the contact details
          provided in the section "HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
        ...
        <p>
          ...
          <a href="mailto:PAIAComplaints@inforegulator.org.za" className="text-blue-600 underline">
            PAIAComplaints@inforegulator.org.za
          </a>{' '}
          &{' '}
          <a href="mailto:POPIAComplaints@inforegulator.org.za" className="text-blue-600 underline">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">15. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        <p>
      ...
      <section>
        ...
        <p>
          <strong>scanby</strong>
          <br />
          Ιωάννου Χρυσοστόμου 6<br />
          Θεσσαλονίκη, Θεσσαλονίκη 54639
          <br />
          Greece
        </p>
      </section>
