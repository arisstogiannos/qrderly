...
export default function FeedbackForm({ isOnboarding = false }: { isOnboarding?: boolean }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-3">
            <div>
              ...
              />
              {errors.rating && (
                <p className="text-sm font-medium text-destructive mt-1">{errors.rating}</p>
              )}
            </div>
          </div>
          ...
          {!isOnboarding && (
            <div className="space-y-2">
              ...
              {errors.feedbackType && (
                <p className="text-sm font-medium text-destructive mt-1">{errors.feedbackType}</p>
              )}
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            {errors.comment && (
              <p className="text-sm font-medium text-destructive">{errors.comment}</p>
            )}
          </div>
