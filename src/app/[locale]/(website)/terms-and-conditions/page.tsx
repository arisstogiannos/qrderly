const TermsAndConditions = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-6">Last updated May 04, 2025</p>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">AGREEMENT TO OUR LEGAL TERMS</h2>
        <p>
          We are scanby ("Company," "we," "us," "our"), a company registered in Greece at Ιωάννου
          Χρυσοστόμου 6, Θεσσαλονίκη, Θεσσαλονίκη 54639. Our VAT number is 177055330.
        </p>
        <p>
          We operate the website{' '}
          <a href="https://www.scanby.cloud" className="text-blue-600 underline">
            www.scanby.cloud
          </a>{' '}
        ...
        <p>
          You can contact us by phone at 6982163367, email at{' '}
          <a href="mailto:info@scanby.cloud" className="text-blue-600 underline">
            info@scanby.cloud
          </a>
          , or by mail to Ιωάννου Χρυσοστόμου 6, Θεσσαλονίκη, Θεσσαλονίκη 54639, Greece.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity ("you"), and scanby, concerning your access to and
      ...
      <section className="mb-6">
        ...
        <p>
          You may not use the Services in a way that would violate the Gramm-Leach-Bliley Act
          (GLBA).
        </p>
      </section>

      <section className="mb-6" id="intellectual-property-rights">
        ...
        <p>
          ...
          info@scanby.cloud. If we ever grant you the permission to post, reproduce, or publicly
        ...
        <h3 className="font-semibold">Your submissions and contributions</h3>
        <p>
      ...
      <section className="mb-6" id="user-representations">
        <h2 className="text-xl font-bold mb-2">3. USER REPRESENTATIONS</h2>
        <p>
      ...
      <section className="mb-6" id="user-registration">
        <h2 className="text-xl font-bold mb-2">4. USER REGISTRATION</h2>
        <p>
      ...
      <section className="mb-6" id="purchases-and-payment">
        <h2 className="text-xl font-bold mb-2">5. PURCHASES AND PAYMENT</h2>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">6. SUBSCRIPTIONS</h2>
        ...
        <p>
          ...
          questions or are unsatisfied with our Services, please email us at info@scanby.cloud.
        </p>
      ...
      <section className="mb-6" id="prohibited-activities">
      ...
      <section className="mb-6" id="user-generated-contributions">
        <h2 className="text-xl font-bold mb-2">8. USER GENERATED CONTRIBUTIONS</h2>
        <p>
      ...
      <section className="mb-6" id="contribution-license">
        <h2 className="text-xl font-bold mb-2">9. CONTRIBUTION LICENSE</h2>
        <p>
      ...
      <section className="mb-6" id="social-media">
        <h2 className="text-xl font-bold">10. Social Media</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mb-4">11. THIRD-PARTY WEBSITES AND CONTENT</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mt-8 mb-4">12. SERVICES MANAGEMENT</h2>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mt-8 mb-4">13. PRIVACY POLICY</h2>
        <p>
        ...
        <p>
          Please be advised the Services are hosted in Germany, Greece and United States. If you
          ...
          Germany, Greece and United States, then through your continued use of the Services, you
          are transferring your data to Germany, Greece and United States, and you expressly consent
          to have your data transferred to and processed in Germany , Greece and United States.
        </p>
      </section>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mt-8 mb-4">15. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          These Legal Terms are governed by and interpreted following the laws of Greece, and the
          use of the United Nations Convention of Contracts for the International Sales of Goods is
          expressly excluded.
        </p>
        <p>
          If your habitual residence is in the EU, and you are a consumer, you additionally possess
          the protection provided to you by obligatory provisions of the law in your country to
          residence.
        </p>
        <p>
          scanby and yourself both agree to submit to the non-exclusive jurisdiction of the courts
          of Thessaloniki, which means that you may make a claim to defend your consumer protection
          rights in regards to these Legal Terms in Greece, or in the EU country in which you
          reside.
        </p>
      </section>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mt-8 mb-4">18. CORRECTIONS</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">19. DISCLAIMER</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">20. LIMITATIONS OF LIABILITY</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">21. INDEMNIFICATION</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">22. USER DATA</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">24. CALIFORNIA USERS AND RESIDENTS</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">25. MISCELLANEOUS</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">26. CONTACT US</h2>
        <p>
