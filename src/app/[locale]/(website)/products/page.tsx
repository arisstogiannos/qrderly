    ...
    <section className="space-y-24 mt-10 ">
      ...
      <header className="space-y-5 bg-primary/20 p-8 backdrop-blur-3xl rounded-3xl">
        ...
        <p className="text-lg md:text-2xl text-balance xl:pr-20">
          Transform the way you serve customers with our powerful digital solutions. Whether you
          need a QR menu, self-ordering system, online ordering platform, or a fully branded
          website, we provide the tools to streamline operations, boost sales, and enhance customer
          experience.
        </p>
      </header>
