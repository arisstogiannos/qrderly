  ...
  return (
    <nav className=" z-50   space-y-2 bg-background-mockup/70  pt-4 text-text-mockup backdrop-blur-xl text-xs">
      ...
      <div className="grid grid-cols-4 gap-4 py-4">
        <div className=" relative col-span-full mx-3 flex outline-primary-mockup/60 items-center gap-3 rounded-full px-2 py-1 outline-2 focus-within:outline-primary-mockup text-primary-mockup">
          <SearchIcon />
          <input
            type="text"
            placeholder="Search"
