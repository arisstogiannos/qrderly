      ...
      <div className="grid md:grid-cols-2 gap-8 gap-x-40 items-start">
        ...
        <motion.div variants={itemVariants} className="space-y-8">
          ...
          >
            ...
            <p className="">{t('details.description')}</p>
          </motion.div>
        ...
        <motion.div variants={itemVariants} className="bg-secondary  sm:p-8 rounded-lg">
          ...
          <div className="space-y-8">
            <motion.div variants={itemVariants} className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-medium text-lg">{t('nextSteps.step1.title')}</h4>
                <p className="">{t('nextSteps.step1.description')}</p>
                {!hasAccount && (
                  <Button variant="default" className="mt-4 bg-foreground text-background " asChild>
            ...
            <motion.div variants={itemVariants} className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-medium text-lg">{t('nextSteps.step2.title')}</h4>
                <p className="">{t('nextSteps.step2.description')}</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
