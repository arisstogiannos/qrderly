    ...
    return (
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-4">
         ...
         { images.length < 15 && <label className="w-24 h-24 rounded-lg bg-accent/30 border-2 border-dashed border-foreground/20 flex items-center justify-center cursor-pointer hover:bg-accent/40 transition-colors">
            <input
              type="file"
