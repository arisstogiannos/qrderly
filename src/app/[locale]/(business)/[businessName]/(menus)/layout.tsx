...
export async function generateStaticParams() {
  const menus = await getActiveMenusNotCached(["QR_MENU","SMART_QR_MENU","SELF_SERVICE_QR_MENU"]);
...
export default async function layout({ children,params }: { children: ReactNode;  params: Promise<{ businessName: string }>;
}) {
