...
import { CategoryWithItemCount, MenuItemWithCategory, Translation } from "@/types";
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
               ...
               {business.menu.template==="T1"?<div className="relative max-w-28 min-w-28 min-h-28 max-h-28 rounded-xl overflow-hidden">
