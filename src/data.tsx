...
import { Bell, Brain, Brush, LayoutDashboard, Palette, Smartphone } from 'lucide-react';
import {
  OrderIcon,
  OrderReceiveIcon,
  TranslationIcon,
...
export const plandata = [
  {
    ...
    free: ['Unlimited Traffic', 'Unlimited Products & Categories', 'Free Hosting', '200 Qr Scans'],
    pro: [
      'Unlimited Traffic',
