      ...
      <div className="my-container grid grid-rows-3 grid-cols-1 lg:grid-cols-3 lg:grid-rows-2">
        ...
        <div className="h-full place-content-end overflow-hidden col-span-full">
          <div className="text-sm flex justify-between mt-auto pb-2">
            <a target="_blank" rel="noreferrer" href="https://aris-stogiannos.gr">
...
function Social() {
  return (
    <div className="flex gap-4">
      ...
      >
        <Image src={'/icons/facebook.png'} width={20} height={20} alt="facebook logo" />
      </a>
      <a
        target="_blank"
        rel="noreferrer"
        ...
        className="p-3 border border-background rounded-full"
      >
        <Image src={'/icons/instagram.png'} width={20} height={20} alt="instagram logo" />
      </a>
      {/* <a
        target="_blank"
        rel="noreferrer"
