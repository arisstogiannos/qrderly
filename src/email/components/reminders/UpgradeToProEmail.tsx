...
export const UpgradeToProEmail = async ({
  username = 'John',
  userEmail = 'john@example.com',
  businessName = "John's Business",
}: UpgradeToProEmailProps) => {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={buttonContainer}>
            <Button
              style={button}
              href={`${baseUrl}/${businessName.replaceAll(' ', '-')}/dashboard`}
            >
              {t('button')}
            </Button>
          </Section>
          ...
          <Section style={unsubscribeContainer}>
            ...
            <Button style={unsubscribeButton} href={`${baseUrl}/user-settings?email=${userEmail}`}>
              {t('unsubscribe')}
            </Button>
          </Section>
        </Container>
