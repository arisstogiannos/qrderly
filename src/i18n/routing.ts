...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    '/get-started/[product]/business-setup': '/get-started/[product]/business-setup',
    '/get-started/[product]/menu-settings': '/get-started/[product]/menu-settings',
    '/get-started/[product]/generate-items': '/get-started/[product]/generate-items',
    '/get-started/[product]/customize-qr': '/get-started/[product]/customize-qr',
